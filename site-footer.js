(function(){
  ...
  footer.innerHTML=`<div class="site-footer-left">&copy; 2026 Eteris Esport - Valorant Premier - powered by Supabase</div><div class="site-footer-right"><a class="site-footer-link" href="status.html">Status</a><a class="site-footer-link" href="account.html">Account</a><a class="site-footer-link" href="rules.html">Rules</a></div>`;
